...
## Project Structure
    ...
    ├── flat_snowflake_44832  # Django project configurations
...
1. Clone this repo and `cd flat_snowflake_44832`
...
2. Clone this repo and `cd flat_snowflake_44832`
