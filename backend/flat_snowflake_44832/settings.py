"""
Django settings for flat_snowflake_44832 project.
...
ROOT_URLCONF = 'flat_snowflake_44832.urls'
...
WSGI_APPLICATION = 'flat_snowflake_44832.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "flat_snowflake_44832 API",
    "DESCRIPTION": "API documentation for flat_snowflake_44832 App",
    "VERSION": "v1",
}
